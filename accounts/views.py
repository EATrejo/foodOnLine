...
# Restrict the vendor to accessing the customer page
...
def registerVendor(request):
    if request.user.is_authenticated:
        ...
        if form.is_valid() and v_form.is_valid():
            ...
            messages.success(request, 'Your account has been registered successfully! Please wait a confirmation email for the approval.')
...
def logout(request):
    auth.logout(request)
    messages.info(request, 'You are logout. See you soon!')
    return redirect('login')
